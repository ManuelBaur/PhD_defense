...
\centering
\Huge{
\textcolor{white}{Measuring the volume fraction of granular packings}}\\
\end{textblock}
...
\frame{
\frametitle{The effective attenuation, $\mu_\text{eff}$}
...
%% ------------------ INTESITY INTEGRAL -------------------------
\frame{
\frametitle{Modeling of $\mu_\text{eff}$}
}

\frame{
\frametitle{Numerical approximation of $\mu_\text{eff}$}

\begin{tikzpicture}[remember picture,overlay]
\fill[blue1]
(current page.north west) rectangle ([xshift=0.22\textwidth,yshift=0.3\textheight]current page.west|-{pic cs:end});
\end{tikzpicture}

\begin{textblock}{0.2}(0.0,0.05)
	\centering
	\textcolor{white}{
	\Large Numerical approximation of $\mu_\text{eff}$}
\end{textblock}



\begin{textblock}{1.}(0.0,0.1)
	\centering
	\visible<1->{
...
\begin{textblock}{0.32}(0.03,0.25)
	\centering
	\visible<1-> {
		\includegraphics[width=\textwidth]
...
\begin{textblock}{0.32}(0.345,0.25)
	\centering
	\visible<1-> {
		\includegraphics[width=\textwidth]
...
\begin{textblock}{0.32}(0.67,0.25)
	\centering
	\visible<1-> {
		\includegraphics[width=\textwidth]

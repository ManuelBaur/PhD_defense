...
\begin{textblock}{0.9}(0.05,0.9)
	\visible<1->{
		\centering
		\Huge{
			\textcolor{red}{Collaboration Norman Uhlmann Fraunhofer EZRT}}}
\end{textblock}
}
...
\begin{tikzpicture}[remember picture,overlay]
\fill[blue1]
(current page.north west) rectangle ([xshift=0.23\textwidth,yshift=0.32\textheight]current page.west|-{pic cs:end});
\end{tikzpicture}

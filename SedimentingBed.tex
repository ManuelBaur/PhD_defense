...
\begin{textblock}{0.45}(0.02,0.45)	
	\centering
	\visible<2->{
...
\begin{textblock}{0.4}(0.52,0.1)
	...
	\vspace{-0.5cm}
	\begin{align}
	\langle v_\text{s} \rangle = \frac{\langle \Delta r \rangle} {\tau_\nu} &&
	\langle \delta v \rangle = \frac{\langle \delta r \rangle} {\tau_{\delta \nu}}
	\nonumber
	\end{align}
	}
	\only<3>{

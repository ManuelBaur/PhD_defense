...
\begin{frame}[noframenumbering]
	...
	\centering
	\textcolor{blue1}{
	Comparison of \newline$\langle v \rangle_\text{xdfa}$ and $\langle v \rangle_\text{front}$}
	}
	\end{textblock}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
\fill[blue1]
(current page.north west) rectangle ([xshift=0.7\paperwidth,yshift=0.33\paperheight]current page.west|-{pic cs:end});
\end{tikzpicture}
...
\frame{
\frametitle{X-DFA for a sedimenting particle suspension}

...
set output '3datapoints_final.eps'
...
set label 11 at 0.05,0.2 font ',30' 'a)' front
...
plot	data_New_60kV_1 u ($1):($3/$1*100) with lines ls 1,\
	data_New_140kV_1 u ($1):($3/$1*100) with lines ls 3,\
	data_New_60kV_2 u ($1):($3/$1*100.) with line ls 11,\
	data_New_60kV_3points u ($1):($3/$1*100.) ls 11 pt 5 ps 2,\
	data_New_140kV_2 u ($1):($3/$1*100.) with lines ls 33,\
	data_New_140kV_3points u ($1):($3/$1*100.) ls 33 pt 7 ps 2 
...
############# print values of 3-data-fit to file for length measurement ##############
set print 'length_measurement/fit_parameters_20_data_fit_60kV.dat'
print a1, b1, alpha1

set print 'length_measurement/fit_parameters_20_data_fit_140kV.dat'
print a3, b3, alpha3

set print 'length_measurement/fit_parameters_3_data_fit_60kV.dat'
print a11, b11, alpha11

set print 'length_measurement/fit_parameters_3_data_fit_140kV.dat'
print a33, b33, alpha33

...
set output 'borosilicate_glass_60kV_model_comparison_multiplot_6.eps'
...
plot    data_60kV u ($1*100):($2/100) ls 1 pt 64 ps 1.5 t '60 kV data',\
	...
	[0.1:] mueff_60kV_d(x) lt 4 lc '#66cc00' lw 5 t 'KS',\
...
set key at 0.6,-0.105 top left maxrows 3 noinvert samplen 4.0

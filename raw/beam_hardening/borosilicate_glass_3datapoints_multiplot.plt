...
plot	data_60kV u ($1*100):($2/100) ls 1 pt 64 ps 1.5,\
	[0.1:] f1(x) ls 1,\
	data_60kV_1 u ($1*100):($2/100) ls 11 pt 5 ps 1.5,\
	[0.1:] f11(x) ls 11,\
	data_140kV u ($1*100):($2/100) ls 3 pt 65 ps 1.5,\
	[0.1:] f3(x) ls 3,\
	data_140kV_1 u ($1*100):($2/100) ls 33 pt 7 ps 1.5,\
	[0.1:] f33(x) ls 33 
...
plot	data_New_60kV_1 u ($1):($3/$1*100) with linespoints ls 1 pt 64 ps 1.5,\
	...
	data_New_60kV_2 u ($1):($3/$1*100.) with linespoints ls 11 pt 64 ps 1.5,\
	data_New_60kV_3points u ($1):($3/$1*100.) ls 11 pt 5 ps 1.5,\
	data_New_140kV_2 u ($1):($3/$1*100.) with linespoints ls 33 pt 65 ps 1.5,\
	data_New_140kV_3points u ($1):($3/$1*100.) ls 33 pt 7 ps 1.5

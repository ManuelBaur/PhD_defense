...
#### all data front and X-DFA scaled relative to mid plane in cuvette
#### px - pitch :: 0.0097424 mm/px
########################################################
...
###############################
### scales
old_scale_midplane = 0.00973 # 0.00973 # mm/px (relative to mid plane of cuvette)
...
xdfa = xdfa_In / old_scale_midplane * new_scale_midplane 

u_xdfa = u_xdfa_In / old_scale_midplane * new_scale_midplane
